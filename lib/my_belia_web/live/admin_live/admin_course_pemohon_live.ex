defmodule MyBeliaWeb.AdminLive.AdminCoursePemohonLive do
  ...
  def handle_event("select-new-status", %{"application_id" => application_id, "new_status" => new_status}, socket) do
    ...
    current_application = Enum.find(socket.assigns.course_applications, &(&1.id == application_id))
  ...
  def handle_event("confirm-status-change", _params, socket) do
    ...
    case CourseApplications.update_application_status(application_id, new_status, current_user.id, nil) do
      {:ok, _application} ->
