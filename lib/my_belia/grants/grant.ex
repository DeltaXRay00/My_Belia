defmodule MyBelia.Grants.Grant do
  ...
  @derive {Jason.Encoder, only: [:id, :name, :description, :purpose, :requirements, :funding_scope, :funding_limit, :funding_period, :image_data, :start_date, :end_date, :start_time, :end_time, :status, :created_by_id, :inserted_at, :updated_at]}
  ...
  def changeset(struct, attrs) do
    ...
    |> cast(attrs, [
      ...
      :funding_limit, :funding_period, :image_data,
